...
func (c *Controller) ServeJSON(encoding ...bool) {
	...
	c.Ctx.ResponseWriter.Header().Add("Access-Control-Allow-Methods", "POST,GET,OPTIONS,DELETE")
	c.Ctx.ResponseWriter.Header().Add("Access-Control-Allow-Headers", "x-requested-with,content-type")
